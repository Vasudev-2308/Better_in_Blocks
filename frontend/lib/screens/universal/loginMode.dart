...
import 'package:frontend/screens/universal/login2.dart';
...
class LoginMode extends StatefulWidget {
  LoginMode({Key key}) : super(key: key);

  @override
  _RegModeWidgetState createState() => _RegModeWidgetState();
}

class _RegModeWidgetState extends State<LoginMode> {
  @override
                ...
                Stack(alignment: Alignment.center, children: [
                  Container(
                      ...
                      child: Column(children: [
                        ...
                        RichText(
                          text: TextSpan(
                              text: 'Dont have an Accont ? Register',
                              style: TextStyle(
